    ...
    <main className="flex-grow px-10 leading-7">
      <div className="max-w-maxw mx-auto">
        ...
        <div className="mt-10 inline-block">
            <div className="sm:flex items-center bg-gray bg-opacity-30 animate-pulse text-transparent">
                <h3 className="text-xl sm:text-2xl font-bold text-center">Found 5 articles</h3>
